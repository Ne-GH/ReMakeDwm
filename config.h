...
/* appearance */
static const unsigned int borderpx  = 2;        /* border pixel of windows ,窗口的边框像素 */
static const unsigned int snap      = 32;       /* snap pixel ,快照像素 */
static const unsigned int gappih    = 2;       /* horiz inner gap between windows ,窗口之间的间隙*/
static const unsigned int gappiv    = 2;       /* vert inner gap between windows, 垂直窗口之间的间隙 */
static const unsigned int gappoh    = 0;       /* horiz outer gap between windows and screen edge ,窗口和屏幕之间的间隙*/
static const unsigned int gappov    = 0;       /* vert outer gap between windows and screen edge ,垂直窗口和屏幕之间的间隙*/
static const int smartgaps          = 1;        /* 1 means no outer gap when there is only one window,1时表示只有一个窗口时没有外部间隙 */
static const int showbar            = 1;        /* 0 means no bar,0表示没有边框*/
static const int topbar             = 0;        /* 0 means bottom bar,0 表示底部状态栏 */
static const Bool viewontag         = True;     /* Switch view on tag switch,在标签开关上切换视图 */
static const char *fonts[]          = { "Source Code Pro:size=12" };  /* 字体和大小 */
static const char dmenufont[]       = "Source Code Pro:size=12";          /* 菜单字体 */
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char col_gray4[]       = "#ffffff";                            /* 4个灰色 */
static const char col_cyan[]        = "#37474f";                            /* 青色 */
...
static const char *Pycharm[] = {"pycharm",NULL};
                                                                        //宽  高
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "85x25", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_b,      spawn,      	   {.v = comptoncmd1 } },
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = comptoncmd2 } },
